    ...
    getBSPs(o, list = []) {
        ...
        if (o instanceof THREE.Object3D) {
            if (o.isMesh && o.geometry) {
                ...
                // Caso não seja BufferGeometry, converta (raro em A-Frame 1.3, mas por segurança)
...
// ----------- Adaptado do ThreeCSG para BufferGeometry ---------------
...
function ThreeBSP(geometry, matrix) {
    ...
    // Assume-se que a geometry é THREE.BufferGeometry
    const polygons = [];
    ...
    if (indexAttr) {
        ...
        // Caso a geometria não tenha índice, cria um array de índices
        indices = [];
    ...
    // Cria polígonos a partir dos índices (cada 3 índices formam um triângulo)
...
ThreeBSP.prototype.toGeometry = function () {
    // Agora retornamos um BufferGeometry
    ...
    for (let i = 0; i < polygons.length; i++) {
        ...
        // Caso o polígono tenha mais de 3 vértices, triangulamos
...
function addVertexToArrays(vertex, invMatrix, positions, normals, uvs, faceNormal) {
    ...
    // Caso o normal do vértice seja nulo ou muito pequeno, use o normal da face
